// DraggableWidget.tsx - Version corrigée (barre d'édition persistante + drag & drop fonctionnel)
  ...
  return (
    ...
    >
      ...
      <style jsx>{`
        ...
        .widget-edit-header.visible {
          opacity: 1;
          transform: translateY(0);
        }
        .widget-edit-header.hidden {
          opacity: 0;
